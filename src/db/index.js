...
var createDb = function (location) {
...
var migrateToLatest = function (db) { return __awaiter(void 0, void 0, void 0, function () {
    var migrator, error;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                migrator = new kysely_1.Migrator({ db: db, provider: migrations_1.migrationProvider });
